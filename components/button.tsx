  ...
  "inline-flex items-center justify-center gap-2.5 text-center font-medium hover:bg-opacity-90 font-medium transition focus:outline-none",
  {
    variants: {
      variant: {
        ...
        delete:
          "bg-red text-white hover:bg-red/90 border border-red hover:border-red/90",
        confirm:
          "bg-green text-white hover:bg-green/90 border border-green hover:border-green/90",
        cancel:
          "bg-gray-200 text-gray-800 hover:bg-gray-300 border border-gray-200 hover:border-gray-300",
      },
      shape: {
        default: "",
        rounded: "rounded-[5px]",
